  ...
  <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav ms-auto py-0">
        <a href="{{ route('home') }}" class="nav-item nav-link {{ request()->routeIs('home') ? 'active' : '' }}" wire:navigate>Beranda</a>
        <a href="{{ route('layanan') }}" class="nav-item nav-link {{ request()->routeIs('layanan') ? 'active' : '' }}" wire:navigate>Layanan</a>
        <a href="{{ route('lacakService') }}" class="nav-item nav-link {{ request()->routeIs('lacakService') ? 'active' : '' }}" wire:navigate>Lacak Service</a>
        
        <a href="{{ route('about') }}" class="nav-item nav-link {{ request()->routeIs('about') ? 'active' : '' }}" wire:navigate>Tentang Kami</a>
      </div>
      @if (Route::has('login'))
      @auth
