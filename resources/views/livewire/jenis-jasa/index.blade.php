<div>
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a wire:navigate href="{{ route('jenis_jasa.view') }}">Jenis Kendaraan</a></li>
    ...
    <div class="card mb-4">
        <div class="card-header justify-content-between d-flex align-items-center">
            ...
            <div>
                <a class="btn btn-primary float-end" href="{{ route('jenis_jasa.create') }}" wire:navigate><i
                        class="fas fa-plus"></i>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('jenis_jasa.edit', ['id' => $jasa->id]) }}" class="btn btn-warning">
