<div>
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a wire:navigate href="{{ route('jenis_jasa.view') }}">Jenis Jasa</a></li>
    ...
    <div class="card mb-4">
        <div class="card-header justify-content-between d-flex align-items-center">
            ...
            <div>
                <a class="btn btn-danger float-end" href="{{  route('jenis_jasa.view') }}" wire:navigate><i
