<div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <style>
                .timeline-container {
                    border-left: 3px solid #198754; /* hijau bootstrap */
                    margin-left: 20px;
                    padding-left: 15px;
                    display: flex;
                    ...
                    <div class="timeline-container position-relative ps-3">
                        ...
                        <div class="timeline-item d-flex mb-4">
                            <div class="timeline-marker me-3 mt-1">
                                <i class="fas fa-circle text-{{ $pembayaran->status == 'lunas' ? 'success' : 'warning' }}"></i>
                            </div>
                            <div class="timeline-content">
                                ...
                                <small class="text-muted">
                                    <i class="fas fa-clock me-1"></i>{{ \Carbon\Carbon::parse($pembayaran->created_at)->format('d M Y H:i') }}
                                </small>
                                <p class="mb-0 mt-1 fs-6">{{ $pembayaran->keterangan ?? '-' }}</p>
                            </div>
                        </div>
                        @empty
                            ...
                            <table class="table table-bordered align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-light fw-bold">
                                        ...
                                        <td class="text-end text-success">Rp {{ number_format($totalJasa, 0, ',', '.') }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td><span class="badge bg-info text-dark">{{ $sp->sparepart->kode ?? '-' }}</span></td>
                                        ...
                                        <td class="text-end">Rp {{ number_format($sp->subtotal ?? 0, 0, ',', '.') }}</td>
                                    </tr>
                                    @endforeach
                                    <tr class="table-light fw-bold">
                                        <td colspan="6">Total Biaya Sparepart</td>
                                        <td class="text-end text-success">Rp {{ number_format($totalSparepart, 0, ',', '.') }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
