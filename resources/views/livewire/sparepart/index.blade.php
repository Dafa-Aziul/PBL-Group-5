                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <input type="number" wire:model.defer="stokInput.{{ $sparepart->id }}"
                                        value="{{ $sparepart->stok }}" class="form-control form-control-sm"
                                        style="width: 70px;">
                                    <button wire:click="updateStok({{ $sparepart->id }})"
                                        class="btn btn-sm btn-success ms-1">
                                        <i class="fas fa-check"></i>
                                    </button>
                                </div>
                                @error("stokInput.$sparepart->id") <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </td>
