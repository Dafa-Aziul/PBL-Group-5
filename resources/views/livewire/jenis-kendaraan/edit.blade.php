            ...
            <form wire:submit.prevent="update">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" wire:model="form.nama_jenis"
                        value="{{ old ('form.nama_jenis', $jenis_kendaraan->nama_jenis) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" wire:model="form.tipe_kendaraan"
                        value="{{ old ('form.tipe_kendaraan', $jenis_kendaraan->tipe_kendaraan) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" wire:model="form.deskripsi"
                        value="{{ old ('form.deskripsi', $jenis_kendaraan->deskripsi) }}">
