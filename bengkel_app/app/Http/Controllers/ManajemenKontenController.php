...
class ManajemenKontenController extends Controller
{
    public function index()
    {
        ...
        return view('ManajemenKonten.index', compact('contents'));
    }

    public function create()
    {
        return view('manajemenKonten.create');
    }
    ...
    public function store(Request $request)
{
    ...
    return redirect()->route('manajemen_konten.index')->with('success', 'Konten berhasil ditambahkan.');
}
    ...
    public function edit($id)
    {
        ...
        return view('manajemenKonten.edit', compact('content'));
    }
    ...
    public function update(Request $request, $id)
{
    ...
    return redirect()->route('manajemen_konten.index')->with('success', 'Konten berhasil diperbarui.');
}
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('manajemen_konten.index')->with('success', 'Konten berhasil dihapus.');
    }
}
