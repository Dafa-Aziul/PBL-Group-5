...
<div class="card mb-4">
  <div class="card-header d-flex justify-content-between align-items-center p-3">
    <h1 class="h4 m-0">Data Konten</h1>
    <a href="{{ route('manajemen-konten.create') }}" class="btn btn-primary">
      ...
      <table class="table table-hover align-middle text-center">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{ route('manajemen-konten.edit', $content->id_konten) }}" class="btn btn-warning btn-sm">
                <i class="bi bi-pencil-fill"></i>
              </a>
              <form action="{{ route('manajemen-konten.destroy', $content->id_konten) }}" method="POST" class="d-inline">
                @csrf
                @method('DELETE')
