<div>
    ...
    <div class="card mb-4">
        <div class="card-header justify-content-between d-flex align-items-center">
            ...
            <div>
                <a class="btn btn-primary float-end" href="<?php echo e(route('user.create')); ?>" wire:navigate><i
                        class="fas fa-plus"></i>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center"><?php echo e($loop->iteration + ($users->currentPage() - 1) *
                                $users->perPage()); ?></td>
                            ...
                            <td class="text-center">
                                <button class="btn btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#confirm-<?php echo e($user->id); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal.confirm','data' => ['id' => 'confirm-'.e($user->id).'','action' => 'modal','targetModal' => 'confirmPassword-'.e($user->id).'','content' => 'Apakah anda yakin untuk menghapus ini?']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'confirm-'.e($user->id).'','action' => 'modal','targetModal' => 'confirmPassword-'.e($user->id).'','content' => 'Apakah anda yakin untuk menghapus ini?']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal.confirmPassword','data' => ['id' => 'confirmPassword-'.e($user->id).'','target' => 'delete('.e($user->id).')','action' => 'modal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'confirmPassword-'.e($user->id).'','target' => 'delete('.e($user->id).')','action' => 'modal']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</div><?php /**PATH D:\Bengkel Proyek\resources\views/livewire/user/index.blade.php ENDPATH**/ ?>