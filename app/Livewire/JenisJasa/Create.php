...
namespace App\Livewire\JenisJasa;
...
class Create extends Component
{
    public JasaForm $form;
        ...
        public function submit(){
            ...
            return redirect()->route('jenis_jasa.view')->with('wire:navigate', true);
        }

    public function render()
    {
        return view('livewire.jenis-jasa.create', ['jenis_kendaraan' => JenisKendaraan::all()]);;
    }
}
